...
urlpatterns = [
    ...
    path("options/subclass/select/", options_views.select_subclass, name="select_subclass"),
    path("options/profession/select/", options_views.select_profession, name="select_profession"),
